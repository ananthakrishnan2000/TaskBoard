          ...
          <div className="modal-overlay">
            <div className="modal-content">
              <div className="modal-header">
                ...
                <button onClick={resetTaskForm} className="close-btn">
                  ×
                </button>
              </div>
        ...
        <div className="tasks-container">
          {filteredTasks.length === 0 ? (
            <div className="empty-state">
              <div className="empty-icon" position="right">
                🔍
              </div>
                  ...
                  <div className="task-footer">
                    <div className="status-actions">
                      <button
                        ...
                        style={{
                          backgroundColor:
                            task.status === "Pending" ? "#f59e0b" : "#f3f4f6",
                        }}
                      >
                        Pending
                      </button>
                      ...
                      <button
                        ...
                        style={{
                          backgroundColor:
                            task.status === "Completed" ? "#10b981" : "#f3f4f6",
                        }}
                      >
                        Completed
                      </button>
